...
//atributos
    //sera la url base de las peticiones web
    private static final String URL_BASE = "http://localhost:8080/mx.com.gm.sga_sga-jee-web_Rest/webservice";
    ...
    public static void main(String[] args) {
        ...
        cliente = ClientBuilder.newClient(); // inicializamos el lciente
    ...
    //metodo para imprimir el lsitado de personas recibidas
